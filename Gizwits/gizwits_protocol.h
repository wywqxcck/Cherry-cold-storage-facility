...
* @{
*/
#define PRODUCT_KEY "6da18be86d8c4de2a8f014ee85d0fb01"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "bc9ce9b97080418f97d86d8858430061"
...
#define co2control_RATIO                         1
#define co2control_ADDITION                      0
#define co2control_MIN                           0
#define co2control_MAX                           5000
#define co2control_LEN                           2
#define co2_RATIO                         1
#define co2_ADDITION                      0
#define co2_MIN                           0
#define co2_MAX                           10000
#define co2_LEN                           2
#define weight_RATIO                         1
#define weight_ADDITION                      0
#define weight_MIN                           0
...
typedef struct {
    ...
    uint32_t valueco2control;
    uint32_t valueco2;
    uint32_t valueweight;
} dataPoint_t;
...
typedef struct {
    ...
    uint8_t flagco2control:1;
    uint8_t flagco2:1;
    uint8_t flagweight:1;
} dataPointFlags_t;
...
typedef struct {
    ...
    uint16_t valueco2control;
    uint16_t valueco2;
    uint16_t valueweight;
} devStatus_t;
